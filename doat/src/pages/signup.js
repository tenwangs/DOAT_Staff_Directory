...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-white">
      <form
        className="bg-gray-100 border-2 shadow-md rounded px-8 pt-8 pb-40 mb-4 max-w-md w-full"
        onSubmit={handleSubmit}
      >
        <h3 className="block text-gray-700 text-sm pl-40 font-bold mb-2">
          Sign Up
        </h3>
        <div className="mb-4">
          <label
        ...
        <div className="mb-6 ">
          <label
            className="block text-gray-700 hover:border-gray-400 text-sm font-semibold mb-2"
            htmlFor="password"
          >
            Password:
          </label>
