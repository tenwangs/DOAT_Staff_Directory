    ...
    <div className="flex items-center pb-8 mt-18 justify-center h-screen bg-white rounded">
      <form className="login bg-gray-100 border-2 shadow-md rounded px-8 pt-8 pb-40 mb-4 max-w-md w-full " onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between">
          <button disabled={isLoading} className="bg-blue-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Log in</button>
          
          <Link to="/forgot-password" className="text-blue-500 underline inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
          Forgot password?
      </Link>
        </div>
